      ...
      if (err) {
                ...
                MODEL.findByIdAndUpdate(foundCategory._id, updatingCategory, function(err, updatedCategory) {
                        if(err){
                                  ...
                                  updatingProduct.productReadingLevel.push({                                                                           // change here
                                    id: updatedCategory._id,
                                    brand:updatedCategory.productReadingLevelName                                                                        // change here
                                  });
                ...
                if (err) {
                   ...
                   console.log();
                    updatingProduct.productReadingLevel.push({                                                                                             /// change here
                        ...
                        readingLevel:newlyCreatedCategory.productReadingLevelName                                                                                /// change here
                   });
