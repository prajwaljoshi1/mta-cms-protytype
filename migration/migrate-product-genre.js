      ...
      if (err) {
                ...
                MODEL.findByIdAndUpdate(foundCategory._id, updatingCategory, function(err, updatedCategory) {
                        if(err){
                                  ...
                                  updatingProduct.productGenre.push({                                                                           // change here
                                    id: updatedCategory._id,
                                    brand:updatedCategory.productGenreName                                                                        // change here
                                  });
  ...
  function createCategoryAndAddToProduct(itemPostName,itemName, itemSlug){
    Product.findOne({slug: itemPostName}, function(err, foundProduct) {
      if (err) {
          ...
          var newCategoryItem = {
              slug:itemSlug,
              productGenreName: itemName,                                                                                                          //change here
              products: []
          }
                ...
                if (err) {
                   ...
                   var updatingProduct = foundProduct
                    updatingProduct.productGenre.push({                                                                                             /// change here
                        ...
                        brand:newlyCreatedCategory.productGenreName                                                                                /// change here
                   });
